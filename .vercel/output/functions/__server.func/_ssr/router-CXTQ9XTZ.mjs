...
const appCss = "/assets/styles-CEB4KY37.css";
...
function getLogoLabel(searchStr) {
...
function Logo({ label }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg tracking-[0.3em] uppercase", children: label })
  ] });
}
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 inset-x-0 z-50 transition-all duration-500 bg-background/85 backdrop-blur-xl border-b border-border ${scrolled ? "py-3" : "py-5"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxury flex items-center justify-between gap-4 xl:gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${scrolled ? "text-foreground" : "text-foreground"} shrink-0`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { label: logoLabel }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden xl:flex flex-1 min-w-0 items-center justify-center gap-5 2xl:gap-7 text-[11px] 2xl:text-[12px] tracking-[0.12em] 2xl:tracking-[0.18em] uppercase whitespace-nowrap", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: n.to,
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 bg-background z-50 animate-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxury flex items-center justify-between py-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { label: logoLabel }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-surface border-t border-border mt-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxury py-20 grid lg:grid-cols-12 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg tracking-[0.3em] uppercase", children: "Softsuite Estates" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-luxury py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground tracking-wide", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        ...
        " Softsuite Estates. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Design by",
        " ",
...
const $$splitComponentImporter$d = () => import("./rent-CZBOCdVF.mjs");
...
const $$splitComponentImporter$c = () => import("./properties-CBxfjpRI.mjs");
...
const $$splitComponentImporter$b = () => import("./investment-D43D5eB3.mjs");
...
const $$splitComponentImporter$7 = () => import("./buy-DsEQnSP0.mjs");
...
const $$splitComponentImporter$6 = () => import("./blog-C7TTQYwT.mjs");
...
const $$splitComponentImporter$5 = () => import("./agents-zR7OfLgy.mjs");
...
const $$splitComponentImporter$4 = () => import("./about-WTcpB3z8.mjs");
...
const $$splitComponentImporter$3 = () => import("./index-CaXvKVCn.mjs");
...
const $$splitComponentImporter$2 = () => import("./properties._id-BWMDinyV.mjs");
...
const $$splitComponentImporter$1 = () => import("./blog._id-BPBT56eS.mjs");
...
const $$splitComponentImporter = () => import("./agents._id-DXtMGkRA.mjs");
